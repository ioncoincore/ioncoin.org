...
#contributors.rb fetches ion Core contributors list and set
#site.contributors array. This is later used to display the
#list of contributors on the "Open Source" page.
  ...
  class CategoryGenerator < Generator
    ...
    def generate(site)
      ...
      if corecontributors_cache_age > 86400 || sitecontributors_cache_age > 86400
        site.corecontributors = contributors('ionomy/ion',site.config['aliases'])
        File.open(corecontributors_cache,'w') do |file|
          Marshal.dump(site.corecontributors, file)
        end
        site.sitecontributors = contributors('ioncoin-dot-org/ioncoin.org',site.config['aliases'])
